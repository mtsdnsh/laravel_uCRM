...
<template>
<div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="lg:w-2/3 w-full mx-auto overflow-auto mt-8">
...
<div v-if="data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto mt-8">
    <table class="table-auto w-full text-left whitespace-no-wrap">
    <thead>
    <tr>
 ...
 <div v-if="data.type === 'rfm'" >
    ...
    <thead>
    <tr>
        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm">Rank</th>
        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm">R</th>
        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm">F</th>
        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm">M</th>
    </tr>
    </thead>
    <tbody>
