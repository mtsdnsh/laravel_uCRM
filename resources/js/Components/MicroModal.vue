    ...
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
      <div class="modal__container w-2/3" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
        ...
        <main class="modal__content" id="modal-1-content">
            <div v v-if="customers.value" class="lg:w-2/3 w-full mx-auto overflow-auto">
        ...
        <footer class="modal__footer">
          <button type="button" @click="toggleStatus" class="modal__btn" aria-label="Close this dialog window">Close</button>
        </footer>
      </div>
    </div>
  </div>
