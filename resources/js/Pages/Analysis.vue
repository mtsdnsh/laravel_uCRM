                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="getData">
                            ...
                            <input type="radio" v-model="form.type" value="rfm">RFM分析
                            <br>
                            From: <input type="date" name="startDate" v-model="form.startDate" />
                            To: <input type="date" name="endDate" v-model="form.endDate" />
                            <div v-if="form.type === 'rfm' " class="merge-auto mt-4">
                                しきい値設定<br>
                               <table class="mx-auto">
                                    <thead>
                                        <tr>
                    ...
                    <div v-show="data.data" class="lg:w-2/3 w-full mx-auto overflow-auto mt-8">
