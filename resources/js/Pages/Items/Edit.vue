                        ...
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                    <div class="relative">
                                        <label for="message" class="leading-7 text-sm text-gray-600">ステータス</label>
                                        <input type="radio" id="is_selling" name="is_selling" value="1" v-model="form.is_selling" class="mr-2 leading-6">
                                        <label for="message" class="ml-2 mr-2">販売中</label>
                                        <input type="radio" id="is_selling" name="is_selling" value="0" v-model="form.is_selling" class="mr-2 leading-6">
                                        <label for="message" class="ml-2 mr-2">停止中</label>
                                    </div>
                                    </div>
                                    <div class="p-2 w-full">
