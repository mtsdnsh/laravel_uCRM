                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="radio" id="gender_0" name="gender" value="0" v-model="form.gender" class="mr-2 leading-6">
                                        <label for="gender_male" class="ml-2 mr-2">男性</label>
                                        <input type="radio" id="gender_1" name="gender" value="1" v-model="form.gender" class="mr-2 leading-6">
                                        <label for="gender_female" class="ml-2 mr-2">女性</label>
                                        <input type="radio" id="gender_2" name="gender" value="2" v-model="form.gender" class="mr-2 leading-6">
                                        <label for="gender_female" class="ml-2 mr-2">その他</label>
